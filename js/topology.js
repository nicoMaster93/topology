...
var topology = {
        ...
        if(typeof data.children != 'undefined' && data.children.length > 0){
            if(prefixLayout == 'deta_' && (typeof dataBase.viewDetail != 'undefined' && dataBase.viewDetail == true)){
                ...
                var node = `<li data-node="${encodeData}" id="parent_li_${idContainerNodes}" class="li_tp_node">
                                <div ${statusNde} data-tpid="${this.domlastActiveTp}" data-prefix="${prefixLayout}" data-parentnodetp="#li_${dataParentNode.replace('#','')}" onmousedown="topology.actionsByNode(this,'${prefixLayout}',event)" id="li_${idContainerNodes}" data-lvl="${data.levelTp}" class="tp_node"><span>${labelNode}</span></div>
            ...
            if(prefixLayout == 'deta_' && (typeof dataBase.viewDetail != 'undefined' && dataBase.viewDetail == true)){
                ...
                var node = `<li data-node="${encodeData}" id="parent_li_${idContainerNodes}" class="li_tp_node">
                                <div ${statusNde} data-tpid="${this.domlastActiveTp}" data-prefix="${prefixLayout}" data-parentnodetp="#li_${dataParentNode.replace('#','')}" onmousedown="topology.actionsByNode(this,'${prefixLayout}',event)" id="li_${idContainerNodes}" data-lvl="${data.levelTp}" class="tp_node not-child"><span>${labelNode}</span></div> 
                            </li>`;  
            }
        }
    ...
    searhByFilterTp(key,value){
        ...
        var li = `<li id="resultFilt${this.domlastActiveTp}">Total Coincidencias: <span class="filter">${coincidencias}</span> ${btnNext} </li>`;
    ...
    infoByNode(nodeId){
        ...
        data = (typeof infoNode.data === 'object' ? infoNode.data : {} );
